        ...
        <div className="max-w-lg mx-auto px-4 pt-6 pointer-events-auto bg-gradient-to-t from-white via-white/95 to-transparent" style={{ paddingBottom: 'max(16px, env(safe-area-inset-bottom, 16px))' }}>
          {whatsappUrl ? (
            <a
              ...
              style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:8, width:'100%', background:'#b85c38', color:'#FFFFFF', fontWeight:600, padding:'14px 0', borderRadius:6, textDecoration:'none', fontSize:14 }}
            >
